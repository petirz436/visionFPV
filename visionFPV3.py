# OpenCV SiamRPN 2 Target Tracker with Kalman Filter Motion Prediction & Pre-processing Pipeline
...
def main():
    ...
    print(" Pipeline : Grayscale + CLAHE / Histogram Equalization")
    print("==========================================================")
    print()
    print("[MOUSE]")
